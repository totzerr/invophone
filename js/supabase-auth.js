...
(function(){
 ...
 window.SwaySupabaseAuth={available:function(){return !!client},identity:identity,signup:signup,signin:signin,reset:reset,updatePassword:updatePassword,finalizeWorkspace:finalizeWorkspace,workspaceMembers:workspaceMembers,loadWorkspaceState:loadWorkspaceState,saveWorkspaceState:saveWorkspaceState,isRecovery:function(){return recovery},isInviteFlow:function(){return invitationAccepted||String(location.hash||'').includes('type=invite')},signout:async function(){if(client)await client.auth.signOut()}};
})();
